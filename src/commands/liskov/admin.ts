...
export default class SlipwayAdmin extends AnalyticsCommand {
  ...
  async run(): Promise<void> {
    this.log("Use `proof liskov admin processor list --help`, `proof liskov admin executor-operation reconcile --help`, `proof liskov admin executor-operation recover-deploy-submit --help`, `proof liskov admin deploy-spend resolve --help`, `proof liskov admin retirement adjudicate-lineage --help`, or `proof liskov admin retirement historical-closeout --help`.");
  }
}
