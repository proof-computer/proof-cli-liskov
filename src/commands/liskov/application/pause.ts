...
export default class SlipwayApplicationPause extends OrganizationScopedCommand {
  static args = {
    app_ref: Args.string({ description: "Liskov Application uid, name, or legacy id.", required: true })
  };
  static description = "Pause new Liskov work for an Application.";
  static examples = [
    "<%= config.bin %> liskov application pause proof-docs",
    "<%= config.bin %> liskov application pause proof-docs --reason \"funding pending\" --yes",
    "<%= config.bin %> liskov application pause app-0123456789abcdef --owner github:12345 --json"
  ];
  ...
  static summary = "Pause new Liskov work for an Application.";
