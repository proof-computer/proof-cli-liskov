...
export default class SlipwayApplicationLockboxGrantStatus extends OrganizationScopedCommand {
  static args = {
  ...
  static examples = [
    ...
    "<%= config.bin %> liskov application lockbox grant-status proof-docs --slipway-url https://slipway.proof.computer"
  ];
