...
export default class SlipwayLogout extends Command {
  static description = "Remove the local Slipway CLI session.";
  static examples = [
    "<%= config.bin %> slipway logout",
    "<%= config.bin %> slipway logout --json"
  ];
  ...
  static summary = "Remove the local Slipway CLI session.";
