...
export default class SlipwayCustodyExecutionSubmit extends Command {
  ...
  static description = "Submit a Slipway live custody execution.";
  static examples = [
    "<%= config.bin %> slipway custody execution submit proof-docs --plan-item-id deploy-1 --idempotency-key key-1 --yes-spend --yes --json"
  ];
