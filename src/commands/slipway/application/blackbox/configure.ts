...
export default class SlipwayApplicationBlackboxConfigure extends Command {
  ...
  static description = "Configure production Blackbox logging for a Slipway Application.";
  static examples = [
    "<%= config.bin %> slipway application blackbox configure proof-docs --yes --json"
  ];
