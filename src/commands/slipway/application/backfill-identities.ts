...
export default class SlipwayApplicationBackfillIdentities extends Command {
  static description = "Backfill Slipway Application identity fields.";
  static examples = [
    "<%= config.bin %> slipway application backfill-identities",
    "<%= config.bin %> slipway application backfill-identities --yes",
    "<%= config.bin %> slipway application backfill-identities --yes --json"
  ];
  ...
  static summary = "Backfill Slipway Application identity fields.";
