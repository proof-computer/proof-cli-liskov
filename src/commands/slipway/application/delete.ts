...
export default class SlipwayApplicationDelete extends Command {
  ...
  static description = "Tombstone a Slipway Application.";
  static examples = [
    "<%= config.bin %> slipway application delete proof-docs",
    "<%= config.bin %> slipway application delete app-0123456789abcdef --reason retired --yes",
    "<%= config.bin %> slipway application delete proof-docs --force --yes --json"
  ];
  ...
  static summary = "Tombstone a Slipway Application.";
